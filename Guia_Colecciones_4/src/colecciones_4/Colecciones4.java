...
public class Colecciones4 {
    ...
    public static void main(String[] args) {
        ...
        pelis.menuIngresarPeliculas();
        pelis.mostrarPeliculas();
        pelis.pelisMayoresa1Hora();
        pelis.pelisOrdenadasPorDuracionDesc();
        pelis.pelisOrdenadasPorDuracionAsc();
        pelis.pelisOrdenadasPorTitulo();
        pelis.pelisOrdenadasPorDirector();
